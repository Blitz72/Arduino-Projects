...
int candleArray[] = {COLOR(15, 14, 0), COLOR(15, 13, 0), COLOR(15, 11, 0), COLOR(15, 10, 0), COLOR(14, 10, 0), COLOR(12, 9, 0), COLOR(13, 11, 0), COLOR(15, 13, 0),
                     COLOR(15, 15, 0), COLOR(15, 13, 0), COLOR(14, 12, 0), COLOR(13, 10, 0), COLOR(12, 8, 0), COLOR(10, 7, 0),COLOR(12, 10, 0), COLOR(14, 12, 0),
                     COLOR(15, 14, 0), COLOR(14, 13, 0), COLOR(15, 15, 0), COLOR(14, 13, 0), COLOR(13, 11, 0), COLOR(14, 12, 0), COLOR(15, 14, 0), COLOR(15, 15, 0),
                     COLOR(14, 13, 0), COLOR(12, 10, 0), COLOR(11, 8, 0), COLOR(10, 7, 0), COLOR(10, 8, 0), COLOR(13, 10, 0), COLOR(14, 12, 0), COLOR(15, 13, 0),
                     COLOR(15, 14, 0), COLOR(15, 15, 0), COLOR(15, 14, 0), COLOR(14, 13, 0), COLOR(13, 12, 0), COLOR(12, 12, 0), COLOR(14, 12, 0), COLOR(15, 13, 0),
                     COLOR(15, 14, 0), COLOR(15, 15, 0)};

int colorTemp2700 = COLOR(0xe, 0x7, 0x3);
...
void loop(){
  for(int i = 0; i < 42; i++){
    setColor(0x01, 0, 0xff, candleArray[i]);
    delay(random(60, 100));
  }
  for(int i = 41; i >= 0; i--){
    setColor(0x01, 0, 0xf0, candleArray[i]);
    delay(random(45, 80));
  }
