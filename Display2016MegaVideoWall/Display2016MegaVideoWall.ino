...
#define olive            COLOR(0x05, 0x07, 0x03)  //85, 107, 47
...
void setColorBitMaskColor(int led, int intensity, int maskA, int maskC, int maskL, int color){
  int _led = led;
  beginAllBitMask(maskA, maskC, maskL);
  ...
  for(i=12;i;i--,(color<<=1))  
    if(color&(1<<11)) oneAllBitMask(maskA, maskC, maskL);
    else zeroAllBitMask(maskA, maskC, maskL);
...
//  noInterrupts();
  ...
  for (int i = 25; i < lightCount; i++)
    setColor(i, defaultIntensity);
  for (int i = 25; i < lightCount; i++)
    setColorBitMask(i, defaultIntensity, 0x91, 0x24, 0x09);
...
void hashtagTheme(){
  ...
  for (int i = 0; i < lightCount; i++)
    setColorAll(i, defaultIntensity, 0);
  for (int i = 0; i < lightCount; i++)
    setColorBitMask(i, defaultIntensity, 0xfc, 0xff, 0x3f);
...
//    setColorAll(i, defaultIntensity, 0);
  ...
  for (int i = 32; i < lightCount; i++)
    setColorBitMask(i, defaultIntensity, 0, 0xff, 0x3f);
  for (int i = 17; i < 31; i++)
    setColorBitMask(i, defaultIntensity, 0, 0, 0xc0);
  interrupts();
}
...
//    setColorAll(i, defaultIntensity, 0);
  for (int i = 17; i < 31; i++)
    setColorBitMask(i, defaultIntensity, 0, 0xf0, 0x3f);
  interrupts();
}
...
void tree1(){
  myFile = SD.open("disp_16/tree18.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree2(){
  myFile = SD.open("disp_16/tree28.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree3(){
  myFile = SD.open("disp_16/tree38.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree4(){
  myFile = SD.open("disp_16/tree48.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree5(){
  myFile = SD.open("disp_16/tree58.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree6(){
  myFile = SD.open("disp_16/tree68.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree7(){
  myFile = SD.open("disp_16/tree78.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree8(){
  myFile = SD.open("disp_16/tree88.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree9(){
  myFile = SD.open("disp_16/tree98.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree10(){
  myFile = SD.open("disp_16/tree108.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree11(){
  myFile = SD.open("disp_16/tree118.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree12(){
  myFile = SD.open("disp_16/tree128.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree13(){
  myFile = SD.open("disp_16/tree138.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree14(){
  myFile = SD.open("disp_16/tree148.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree15(){
  myFile = SD.open("disp_16/tree158.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree16(){
  myFile = SD.open("disp_16/tree168.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree17(){
  myFile = SD.open("disp_16/tree178.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree18(){
  myFile = SD.open("disp_16/tree188.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree19(){
  myFile = SD.open("disp_16/tree198.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree20(){
  myFile = SD.open("disp_16/tree208.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree21(){
  myFile = SD.open("disp_16/tree218.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree22(){
  myFile = SD.open("disp_16/tree228.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree23(){
  myFile = SD.open("disp_16/tree238.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree24(){
  myFile = SD.open("disp_16/tree248.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree25(){
  myFile = SD.open("disp_16/tree258.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree26(){
  myFile = SD.open("disp_16/tree268.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree27(){
  myFile = SD.open("disp_16/tree278.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void tree28(){
  myFile = SD.open("disp_16/tree288.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
...
void treeLights(){
  ...
  setColorBitMaskColor(20, defaultIntensity, 0x04, 0, 0, red);         //1
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(22, defaultIntensity, 0, 0x20, 0, blue);        //2
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(29, defaultIntensity, 0x80, 0, 0, green);       //3
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(26, defaultIntensity, 0, 0, 0x01, green);       //4
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(32, defaultIntensity, 0, 0x01, 0, blue);        //5
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(20, defaultIntensity, 0x20, 0, 0, magenta);     //6
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(16, defaultIntensity, 0, 0x08, 0, red);         //7
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(33, defaultIntensity, 0, 0, 0x01, blue);        //8
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(20, defaultIntensity, 0, 0x04, 0, orange);      //9
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(26, defaultIntensity, 0, 0x10, 0, orange);      //10
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(23, defaultIntensity, 0x01, 0, 0, blue);        //11
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(22, defaultIntensity, 0x40, 0, 0, green);       //12
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(15, defaultIntensity, 0, 0x01, 0, blue);        //13
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(20, defaultIntensity, 0x20, 0, 0, red);         //14
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(19, defaultIntensity, 0, 0x80, 0, yellow);      //15
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(29, defaultIntensity, 0, 0x04, 0, yellow);      //16
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(30, defaultIntensity, 0, 0x80, 0, magenta);     //17
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(26, defaultIntensity, 0x04, 0, 0, yellow);      //18
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(18, defaultIntensity, 0x08, 0, 0, orange);      //19
  interrupts();
  delay(random(MIN, MAX));
  noInterrupts();
  setColorBitMaskColor(15, defaultIntensity, 0, 0, 0x01, magenta);     //20
  interrupts();
...
void slide2016(){
  myFile = SD.open("disp_16/sl20168.txt", FILE_READ);
  noInterrupts();
  for (int i = 0; i < lightCount; i++){
    for (int j = 0; j < 12; j++){
      a[i][j] = myFile.read();
